...
/* Dirección MAC de difusión Multicast */
extern mac_addr_t RIP_MAC_MCAST_ADDR;
 ...
 *
 * DESCRIPCION:
 *   Esta función comprueba que la mac destino es válida.
 *
 * PARAMETROS:
 * 'mac_addr': Mac destino a donde va la la trama
 * 'iface': Estructura donde está contenida mi mac.
 *
 * VALOR DEVUELTO:
 *  La funcion devuelve 1 si somos un destino válido para esa mac, 0 en caso contrario.
 *
 *
 */
int check(mac_addr_t mac_addr,struct eth_iface *iface);
